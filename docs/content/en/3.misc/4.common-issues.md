...
@nuxtjs/style-resources does only work with Webpack config and is not supported by nuxt-vite.

You must configure global CSS usage using `preprocessorOptions` option of CSS loader.
